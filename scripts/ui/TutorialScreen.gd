...
func _steps() -> Array:
	return [
		...
		{"n": 6, "title": "Addomesticamento — e la rinuncia allo scatto", "text": "Tasto F o tasto X/Quadrato del controller: rende alleato il nemico comune più vicino. Attenzione, è una scelta: dal momento in cui hai anche un solo alleato PERDI LO SCATTO, su entrambi i pulsanti. In cambio ottieni gli attacchi speciali degli alleati. Se tutti i tuoi alleati cadono, lo scatto torna disponibile. Un alleato non è solo un attacco in più: gli avversari attaccano chi hanno più vicino tra te e i tuoi alleati, quindi mandarne uno avanti se li tira addosso e ti toglie pressione, al prezzo della sua vita. Puoi avere al massimo 2 alleati contemporaneamente, riconoscibili dall'anello acqua che li circonda; restano al tuo fianco finché non muoiono o non concludi/riavvii la run, e l'addomesticamento ha un tempo di recupero prima di poter essere riusato. Se ti allontani troppo, un alleato rimasto indietro accelera sempre di più per raggiungerti, quindi non serve aspettarlo."},
		{"n": 7, "title": "Attacchi speciali degli alleati", "text": "Gli stessi due pulsanti dello scatto (E/R1 e Q/L1): ogni alleato vivo ne occupa uno con il proprio attacco speciale (vedi sotto, ciascuno con un effetto visivo riconoscibile), cosí con 2 alleati diversi hai 2 attacchi distinti utilizzabili in modo indipendente, ciascuno con il proprio tempo di recupero. Ogni attacco ha un ritmo proprio: quello in corpo a corpo fa molto danno ma torna pronto lentamente, quello a distanza punge poco ma si tira quasi a raffica, quello ad area sta nel mezzo ma colpisce tutti i nemici vicini. Con un solo alleato il pulsante rimasto libero resta inattivo finché non ne addomestichi un secondo. Se addomestichi due nemici dello stesso tipo, i due alleati condividono un solo pulsante ma con una versione potenziata dell'attacco. Se un alleato muore, il suo attacco sparisce (o torna alla versione normale, se era potenziato)."},
		{"n": 8, "title": "Comandi personalizzabili", "text": "Tutti i tasti qui indicati sono quelli predefiniti: dalla voce Impostazioni dell'Hub puoi riassegnare movimento, pulsanti d'attacco, addomesticamento e pausa, oltre a regolare volume, risoluzione e schermo intero."},
		{"n": 9, "title": "Potenziamenti per ogni stile", "text": "Le scelte di fine stanza coprono entrambi i modi di combattere: alcune rafforzano lo scatto, altre gli alleati e i loro attacchi speciali (danno, tempi di recupero, vita degli alleati, addomesticamento più rapido). Finché hai alleati, i potenziamenti dedicati al solo scatto non ti vengono nemmeno proposti — tranne il leggendario Vincolo Spezzato, che ti lascia lo scatto anche con gli alleati al seguito."},
	]
