...
const ENEMY_TYPES := {
	"strisciante": {
		...
		"behavior": "chase", "contact_cooldown": 0.6, "shape": "slime", "attack_pattern": "morso",
	...
	"pungiglione": {
		...
		"shape": "flower", "attack_pattern": "agguato",
	...
	"corazzato": {
		...
		"behavior": "chase", "contact_cooldown": 0.8, "min_room": 3, "shape": "brute", "attack_pattern": "salto",
		"desc": "Una massa corazzata che avanza a piccoli balzi: ogni atterraggio scarica a terra un'onda d'urto. Lenta, ma devastante da vicino. Appare dalla terza stanza.",
	...
	"sciame": {
		...
		"shape": "insect", "attack_pattern": "carica",
		"desc": "Insetti volanti dalle mandibole spalancate, sempre in sciame. A tiro della preda si fermano a caricare per un attimo, poi si lanciano in picchiata. Appaiono dalla seconda stanza.",
...
const BOSSES := {
	"custode": {
		...
		"damage": 18.0, "color": Color8(58, 42, 82), "shape": "custode", "glow": Color8(150, 196, 255),
	...
	"colosso": {
		...
		"damage": 20.0, "color": Color8(74, 66, 58), "shape": "colosso", "glow": Color8(238, 154, 74),
	...
	"spettro": {
		...
		"damage": 14.0, "color": Color8(92, 112, 138), "shape": "spettro", "glow": Color8(168, 226, 232),
