...
- **Attacco speciale dell'alleato**: `Q`, oppure il tasto Y (Xbox) / Triangolo (PlayStation) del controller. Il tipo di nemico reso alleato più di recente (tra quelli ancora vivi) concede un attacco a tema, attivabile con il proprio tempo di recupero indipendente da quello dello scatto e dell'addomesticamento: lo Strisciante dà un balzo mordente in corpo a corpo, il Pungiglione un dardo avvelenato a distanza, il Corazzato un'onda d'urto intorno a te, lo Sciame una raffica di proiettili in tutte le direzioni. Se quell'alleato muore, l'attacco passa a un altro alleato ancora in vita o sparisce se non ne resta nessuno.
